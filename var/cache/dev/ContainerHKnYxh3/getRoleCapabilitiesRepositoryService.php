...
// Returns the private 'App\Repository\RoleCapabilitiesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/RoleCapabilitiesRepository.php';

return $this->privates['App\Repository\RoleCapabilitiesRepository'] = new \App\Repository\RoleCapabilitiesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
