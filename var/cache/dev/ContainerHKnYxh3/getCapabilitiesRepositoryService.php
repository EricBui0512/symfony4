...
// Returns the public 'App\Repository\CapabilitiesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/Interfaces/CapabilityRepoInterface.php';
include_once $this->targetDirs[3].'/src/Repository/CapabilitiesRepository.php';

return $this->services['App\Repository\CapabilitiesRepository'] = ($this->services['doctrine.orm.default_entity_manager'] ?? $this->load('getDoctrine_Orm_DefaultEntityManagerService.php'))->getRepository('App\\Entity\\Capabilities');
