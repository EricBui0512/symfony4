...
// Returns the private 'App\Repository\ContextLevelsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ContextLevelsRepository.php';

return $this->privates['App\Repository\ContextLevelsRepository'] = new \App\Repository\ContextLevelsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
