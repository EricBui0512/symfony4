...
// Returns the private 'App\Repository\ContextRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ContextRepository.php';

return $this->privates['App\Repository\ContextRepository'] = new \App\Repository\ContextRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
