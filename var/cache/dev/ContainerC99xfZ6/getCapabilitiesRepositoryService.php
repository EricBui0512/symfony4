...
// Returns the private 'App\Repository\CapabilitiesRepository' shared autowired service.
...
return $this->privates['App\Repository\CapabilitiesRepository'] = new \App\Repository\CapabilitiesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
