...
$this->services['App\Controller\AdminUserController'] = $instance = new \App\Controller\AdminUserController(($this->services['App\Repository\UserRepository'] ?? $this->load('getUserRepositoryService.php')));
