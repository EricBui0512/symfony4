...
$this->services['App\Controller\UserController'] = $instance = new \App\Controller\UserController(($this->services['App\Repository\UserRepository'] ?? $this->load('getUserRepositoryService.php')));
