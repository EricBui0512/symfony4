...
// Returns the private 'App\Repository\RoleAssignmentRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/RoleAssignmentRepository.php';

return $this->privates['App\Repository\RoleAssignmentRepository'] = new \App\Repository\RoleAssignmentRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
