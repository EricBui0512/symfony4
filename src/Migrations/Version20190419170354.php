 ...
 */
final class Version20190419170354 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE capabilities (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_1D3B2DFD5E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `group` (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, time_modified DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, modifier_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE role (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, short_name VARCHAR(50) NOT NULL, description LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_57698A6A5E237E06 (name), UNIQUE INDEX UNIQ_57698A6A3EE4B093 (short_name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE role_assignment (id INT AUTO_INCREMENT NOT NULL, role_id_id INT NOT NULL, context_id_id INT NOT NULL, user_id_id INT NOT NULL, modifier_id_id INT NOT NULL, time_start DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, time_end DATETIME DEFAULT NULL, time_modified DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, INDEX IDX_BFF12E9688987678 (role_id_id), INDEX IDX_BFF12E962E53F229 (context_id_id), INDEX IDX_BFF12E969D86650F (user_id_id), INDEX IDX_BFF12E9648A98969 (modifier_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, fullname VARCHAR(255) DEFAULT NULL, username VARCHAR(255) NOT NULL, password_hash VARCHAR(255) NOT NULL, password_salt VARCHAR(255) NOT NULL, time_modified DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE role_assignment ADD CONSTRAINT FK_BFF12E9648A98969 FOREIGN KEY (modifier_id_id) REFERENCES user (id)');
        ...
        $this->addSql('ALTER TABLE users_group ADD CONSTRAINT FK_8AB7E08C2F68B530 FOREIGN KEY (group_id_id) REFERENCES `group` (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE role_assignment DROP FOREIGN KEY FK_BFF12E9648A98969');
        $this->addSql('ALTER TABLE users_group DROP FOREIGN KEY FK_8AB7E08C9D86650F');
