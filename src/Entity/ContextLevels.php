...
/**
 * @ORM\Entity(repositoryClass="App\Repository\ContextLevelsRepository")
 */
class ContextLevels
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Context", mappedBy="context_level_id", orphanRemoval=true)
     */
    private $contexts;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\RoleCapabilities", mappedBy="context_level_id", orphanRemoval=true)
     */
